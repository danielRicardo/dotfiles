...
complete -f -c git -n "__fish_git_using_command remote; and __fish_seen_subcommand_frocomplee" -l dry-run -d 'Report what will be pruned but do not actually prune it'
